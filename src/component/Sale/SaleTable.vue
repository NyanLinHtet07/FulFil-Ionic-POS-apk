    ...
    <ion-content v-else>
         <ion-content v-if="! visiable">
           ...
           <ion-header class=" top ion-no-border mt-1">
             <ion-chip @click="openItems" color="primary" class="mx-2"> Products </ion-chip>
            ...
            <ion-grid class=" w-full">
                ...
                <ion-row v-for="product in cartItems" :key="product.id" class="ion-text-center bg-sky-50">
                        ...
                        <!-- <ion-col>
                            <ion-input :value="product.price * product.quantity" readonly="readonly" class="text-sm"></ion-input>
                 ...
                 <ion-card class=" w-full rounded-lg mx-1 my-2  px-2 py-3 bg-gradient-to-t from-sky-200 to to-lime-50">
                    ...
                    <ion-card-content>
                        ...
                        <ion-item class="my-2 mx-3 rounded-lg ring-1 ring-sky-100"> 
                            ...
                            <!-- <ion-input input="text" v-model="saleData.customer_email" readonly="readonly"></ion-input> -->
                        </ion-item>
                            ...
                            <ion-item class="my-2 mx-3 rounded-lg ring-1 ring-sky-100">
                                <ion-label position="floating"> Add Description </ion-label>
                                 <ion-input input="text" v-model="saleData.description"></ion-input>
                                  <!-- <small v-if="! saleData.description" class=" text-sm text-ellipsis text-red-800 font-bold"> Description Require</small> -->
                            </ion-item>
