                                            ...
                                            <span v-if="product.variant.pricing_type == p.multi_price">
                                                    ...
                                                    <span v-if=" p.multi_price == 0"> -->
                                                      ...
                                                      <!-- <label for=""> Price </label> -->
                                                        ...
                                                        <!-- <div @click.self="test1(p.price, product.id)">{{p.price}}</div>  -->
                                                         <!-- <ion-input  @input="test1(p.price, product.id)" :value="p.price" class="text-sm"> </ion-input> -->
                                                        <!-- <p>{{product.price}}</p>
                                                    </span>
                                                    <span v-else>
                                                        <span v-if="p.min <= product.quantity && ( p.max >= product.quantity || p.max == null ) ">  -->
                                                               ...
                                                               <!-- <label for=""> Price </label> -->
                                                                ...
                                                                <!-- <input  @input="test1(p.price, product.id)" :placeholder="p.price"/> -->
                                                                <!-- <p> {{product.price}}</p>
                                                        </span>
                                                    </span>
                                                </span>
